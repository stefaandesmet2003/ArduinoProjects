...
void build_loko_14a28s(unsigned int nr, signed char speed, t_message *new_message);
 
void build_loko_14a128s(unsigned int nr, signed char speed, t_message *new_message);

void build_loko_7a_restricted(unsigned int nr, unsigned char res_speed, t_message *new_message);

void build_loko_14a_restricted(unsigned int nr, unsigned char res_speed, t_message *new_message);
