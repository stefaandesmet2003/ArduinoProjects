/*
 * we beginnen met een simpele feedback decoder met 8 inputs D3->D1,C7->C4,C8
 * B4/B5 vrijhouden voor I2C expander
 * A3 : direction
...
//#define DEBUG -> nog geen altserial op STM8

#define RS485_DIRECTION_PIN   PA3     // hw specific!
#define XPNET_MY_ADDRESS (6)
...
static void decoder_init(void) {
  uint8_t pins[] = {PD3,PD2,PD1,PC7,PC6,PC5,PC4,PC3};

  decoderState.nbrInputs = 8; // 8 or 16 supported
  decoderState.myAddress = 65; // xpnet accessory address 
